...
sealed class CategoryViewState {
     ...
     */
    object LoadingState : CategoryViewState()

    /**
     * Ane error has ocurred while loading the data
     */
    data class ErrorState(val error: Throwable) : CategoryViewState()

    /**
     * Data has been loaded successfully and can now be displayed
     */
    data class DataState(val products: List<Product>) : CategoryViewState()
}
