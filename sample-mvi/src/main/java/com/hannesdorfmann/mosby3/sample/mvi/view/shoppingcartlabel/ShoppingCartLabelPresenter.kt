...
/**
 * Presenter for  [ShoppingCartLabelView] that displays the number of items in the shopping
 * cart
 *
 * @author Hannes Dorfmann
 */
class ShoppingCartLabelPresenter(private val shoppingCart: ShoppingCart) : MviBasePresenter<ShoppingCartLabelView, Int>() {
    ...
    override fun bindIntents() {
        ...
        subscribeViewState(numberOfItemsInShoppingCart) { obj, intemsInShoppingCart -> obj.render(intemsInShoppingCart) }
    }
}
