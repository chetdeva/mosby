...
class HomeFeedLoader(private val groupedLoader: GroupedPagedFeedLoader,
    ...
    fun loadNewestPage(): Observable<List<FeedItem>> {
        return groupedLoader.newestPage.delay(2, TimeUnit.SECONDS)
    }
    ...
    fun loadFirstPage(): Observable<List<FeedItem>> {
        return groupedLoader.groupedFirstPage.delay(2, TimeUnit.SECONDS)
    }
    ...
    fun loadNextPage(): Observable<List<FeedItem>> {
        return groupedLoader.groupedNextPage.delay(2, TimeUnit.SECONDS)
    }
